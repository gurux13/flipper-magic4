...
void nfc_magic_gen4_scene_write_confirm_widget_callback(
...
void nfc_magic_gen4_scene_write_confirm_on_enter(void* context) {
    NfcMagic* nfc_magic = context;
    ...
    widget_add_button_element(
        ...
        GuiButtonTypeCenter,
        "Continue",
        nfc_magic_gen4_scene_write_confirm_widget_callback,
        nfc_magic);
    widget_add_button_element(
        widget,
        GuiButtonTypeLeft,
...
bool nfc_magic_gen4_scene_write_confirm_on_event(void* context, SceneManagerEvent event) {
    NfcMagic* nfc_magic = context;
    bool consumed = false;
...
void nfc_magic_gen4_scene_write_confirm_on_exit(void* context) {
    NfcMagic* nfc_magic = context;
